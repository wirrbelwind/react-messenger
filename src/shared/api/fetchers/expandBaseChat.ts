import { IBaseChat, IChatWithoutLastMsg, IGroupChat, IPrivateChat } from "shared/libs/interfaces/chats";
import { fetchCompanion } from "./fetchCompanion";
import { fetchGroup } from "./fetchGroup";
import { FirestoreApi } from "../firestore-api";

export async function expandBaseChat(api: FirestoreApi, chat: IBaseChat): Promise<IChatWithoutLastMsg> {
	if (chat.type === 'direct') {
